...
then identifies the longest word in the file that can be constructed by concatenating copies of shorter words also
found in the file.
...
For example, if the file contained:
  ...
  rat
  ratcatdogcat
The answer would be <b>'ratcatdogcat'</b> - at 12 letters, it is the longest word made up of other words in the list. 
...
=== Critics
Fairly quick Ruby hash solution. No count was included, but it was easily modifiable to include the correct account.
However, he unfortunately didn't read the instructions. And, he didn't bother to instantiate his PrefixTree class
